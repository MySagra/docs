...
- **[Quick Start](/)**  — generate your `docker-compose.yml`, `.env`, and `nginx.conf` in minutes and get the stack running
- **[Self Hosting](/docs/self_hosting)** — deep-dive into certificates, Nginx configuration, and production hardening
