...
```json
{
  ...
  "confirmedAt": "2025-11-04T10:30:00Z",
...
| `confirmedAt` | `string` | ISO 8601 last update timestamp, it can be `null`    |
| `completedAt` | `string` | ISO 8601 last update timestamp, it can be `null`     |
...
```json
{
  "orderItems": [{ "id": "clx0abc0001mx01example" }],
